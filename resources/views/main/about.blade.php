@section('meta_tag')
    ...
    <meta property="og:title" content="{{ optional($pageSetups['about'])->title ?? 'About Us' }}">
    <meta property="og:description" content="{{ optional($pageSetups['about'])->meta_description ?? '' }}">
    ...
    <meta name="twitter:title" content="{{ optional($pageSetups['about'])->title ?? 'About Us' }}">
    <meta name="twitter:description" content="{{ optional($pageSetups['about'])->meta_description ?? '' }}">
...
<x-layouts.main>
    ...
    <section class="relative bg-cover bg-center bg-no-repeat min-h-[40vh] sm:h-[50vh] flex justify-center items-center"
        ...
        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col text-center">
            <!-- Title -->
            <h2 class="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4">About Us</h2>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-xs sm:text-sm font-medium text-white md:ms-2">About Us</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                <img src="{{ asset('storage/' . $about->image) }}" alt="Private Jet Experience"
                        class="w-full h-[300px] sm:h-[400px] lg:h-full object-cover rounded-lg shadow-md mb-6 lg:mb-0">

                <!-- Text Section -->
                <div class="flex flex-col justify-center">
                    <!-- Section Subtitle -->
                    <h3 class="text-[#FFDA03] text-base sm:text-lg font-semibold mb-2">ABOUT OUR COMPANY</h3>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div class="flex flex-col">
                    <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">Vision</h2>
                ...
                <div class="flex flex-col mt-6 lg:mt-0">
                    <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">Mission</h2>
                    <p class="text-sm sm:text-base text-gray-600">
                        {{ $about->mission }}
                    </p>
                </div>
