...
<x-layouts.main>
    ...
    <section class="relative bg-cover bg-center bg-no-repeat min-h-[40vh] sm:h-[50vh] flex justify-center items-center"
        ...
        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col text-center">
            <!-- Title -->
            <h2 class="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4">Fleets</h2>
    ...
    <section class="py-8 sm:py-12 lg:py-16">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col justify-center mb-6 sm:mb-8 text-center">
                <!-- Section Subtitle -->
                <h3 class="text-[#FFDA03] text-base sm:text-lg font-semibold mb-1 sm:mb-2">OUR FLEETS</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 justify-center">
                @forelse ($fleets as $fleet)
                    ...
                    <div class="flex flex-col sm:flex-row items-center border border-gray-300 rounded-lg overflow-hidden shadow-md">
                        <!-- Image Section -->
                        <a href="{{ route('fleet.details', $fleet->slug) }}" class="w-full sm:w-1/3">
                        ...
                        <div class="w-full sm:w-2/3 p-4 sm:p-6">
                            <a href="{{ route('fleet.details', $fleet->slug) }}">
                                <h5 class="text-lg sm:text-xl font-bold text-gray-800 mb-2">{{ $fleet->title }}</h5>
                            </a>
                ...
                @empty
                    ...
                    <div class="flex flex-col sm:flex-row items-center border border-gray-300 rounded-lg overflow-hidden shadow-md">
                        ...
                        <div class="w-full sm:w-2/3 p-4 sm:p-6">
                            <a href="#">
                                <h5 class="text-lg sm:text-xl font-bold text-gray-800 mb-2">No Data</h5>
                            </a>
                            <p class="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
                            </p>
                            <a href="" class="text-[#1A2D73] text-sm sm:text-base font-semibold hover:underline">Discover
                                More</a>
                        </div>
                    </div>
                @endforelse
