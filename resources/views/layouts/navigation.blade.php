    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.fleets.index')" :active="request()->routeIs('admin.fleets.index')">
                        {{ __('Fleet') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.hero-sections.index')" :active="request()->routeIs('admin.hero-sections.index')">
                        {{ __('Hero Section') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.page-setups.index')" :active="request()->routeIs('admin.page-setups.index')">
                        {{ __('Page Setup') }}
                    </x-nav-link>
                </div>
